...
/**
 * Created by CJ on 2018/4/8.
 *
 * a fragment used for showing PopularPage news
 */

public class TabFragmentPolitics extends Fragment {
    ...
    public static Fragment newInstance() {
        TabFragmentPolitics fragment = new TabFragmentPolitics();
        return fragment;
    ...
    public void setConfigOfRecyclerVIew(final ArrayList<ArrayList<String>> container){
        ...
        mAdapter = new PopularPageAdapter(getActivity().getApplication(),containerList);
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle saveInstanceState){
        ...
        Log.d("fragment","frament politics_oncreateview");
    ...
    public void onStart(){
        super.onStart();
        Log.d("fragment","frament politics_onstart");
    }

    @Override
    public void onResume(){
        super.onResume();
        Log.d("fragment","frament politics_onresume");
    }

    @Override
    public void onPause(){
        super.onPause();
        Log.d("fragment","frament politics_onpause");
    }

    @Override
    public void onStop(){
        super.onStop();
        Log.d("fragment","frament politics_onstop");
    }

    @Override
    public void onDestroyView(){
        super.onDestroyView();
        Log.d("fragment","frament politics_ondestroyview");
    }
